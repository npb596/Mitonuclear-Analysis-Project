...
grep "scaffold" introgression_GENENAME > output.csv
cat introgression* > FDM_measurements_temp
grep -v "scaffold" FDM_measurements_temp >> output.csv
